...
### Respondents Hide Their Feelings
...
### Can We Measure Hidden Feelings?
...
$P(Observed) = P(Heads)*P(Truth) + P(Tails)*1$

Solve for the unknown: 

$P(Truth) = \frac{P(Observed) - P(Tails)}{P(Heads)}$
...
| Treatment | [Violent actor] believers that Muslim women must demonstrate modesty by wearing a veil. Others say that women should have the right to decide. Which opinion do you agree with? |
